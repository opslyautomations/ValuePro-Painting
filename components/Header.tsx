...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile full-screen drawer — rendered outside <header> because its
        backdrop-blur makes it a containing block for position:fixed
        descendants, which would trap this drawer inside the 80px header
